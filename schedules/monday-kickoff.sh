#!/bin/bash
# Monday Kickoff - runs at 9am every Monday
# Cron: 0 9 * * 1 ~/ai-context/schedules/monday-kickoff.sh
...
echo "=== Monday Kickoff - $(date) ===" >> "$LOG_FILE"
...
/usr/local/bin/claude -p "monday kickoff" \
